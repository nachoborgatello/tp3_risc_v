...
HD_PWD='C:/Users/ignac/Downloads/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_debug_system.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_debug_system.tcl -notrace
