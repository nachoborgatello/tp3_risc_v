...
HD_PWD='C:/Users/ignac/Downloads/project_1/project_1.runs/clk_wiz_50m_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_wiz_50m.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_wiz_50m.tcl
