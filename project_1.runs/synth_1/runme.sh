...
HD_PWD='C:/Users/ignac/Downloads/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_debug_system.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_debug_system.tcl
