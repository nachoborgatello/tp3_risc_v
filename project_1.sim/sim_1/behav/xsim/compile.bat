...
REM
REM Generated by Vivado on Wed Jan 28 17:34:57 -0300 2026
...
echo "xvlog --incr --relax -prj tb_debug_unit_uart_vlog.prj"
call xvlog  --incr --relax -prj tb_debug_unit_uart_vlog.prj -log xvlog.log
