...
REM
REM Generated by Vivado on Sat Jan 24 11:02:11 -0300 2026
...
echo "xvlog --incr --relax -prj tb_top_debug_system_vlog.prj"
call xvlog  --incr --relax -prj tb_top_debug_system_vlog.prj -log xvlog.log
